[README (6).md](https://github.com/user-attachments/files/27104195/README.6.md)
...
git clone https://github.com/jblumbasi-munialo/Drug-Discovery-AI-Platform.git
...
@misc{DrugDiscoveryAIPlatform2026,
  ...
  year = {2026},
  publisher = {GitHub},
  url = {https://github.com/jblumbasi-munialo/Drug-Discovery-AI-Platform}
}
```
